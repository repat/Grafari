...
CombinedRequest.prototype.toString = function () {
    return "CombinedRequest(" + this.requests.map(function (x) {
        return x.toString()
    }).join() + ")"
}
...
Disjunction.prototype.toString = function () {
    return "Disjunction(" + this.conjunctions.map(function (x) {
        return x.toString()
    }).join() + ")"
}
...
Conjunction.prototype.toString = function () {
    return "Conjunction(" + this.conditions.map(function (x) {
        return x.toString()
    }).join() + ")"
}
